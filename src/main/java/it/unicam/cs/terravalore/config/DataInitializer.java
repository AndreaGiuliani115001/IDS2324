...
import it.unicam.cs.terravalore.model.utenti.Turista;
...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase() {
        return args -> {
            ...
            puntoInteresseRepository.saveAll(Arrays.asList(punto1, punto2, punto3));
            ...
            contenutoRepository.saveAll(Arrays.asList(contenuto1, contenuto2, contenuto3));
            ...
            contributore.setComuniAssociati(Arrays.asList(comune1, comune2));
